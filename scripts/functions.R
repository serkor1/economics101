...
# Demand function;
demand_function <- function(shock = NULL, coeff = 2) {
...
equilibrium_plot <- function(demand, supply) {
  ...
  # TODO: The addition of CS and PS
  # should be subject to if-statemetns
  # about complexity.
  ...
  # 
  # %>% add_ribbons(
  #   x = 0:intersection$x_int,
  #   ymin = supply_curve$y[1:10],
  #   ymax = intersection$y_int,
  #   name = "Producer Surplus",
  #   fillcolor = "steelblue",
  #   opacity = 0.2
  ...
  #   x = 0:intersection$x_int,
  #   ymin = intersection$y_int,
  #   ymax = demand_curve$y[1:length(demand_curve$x:intersection$x_int)],
  #   name = "Consumer Surplus",
  #   fillcolor = "darkred",
  #   opacity = 0.2
  # )
...
stat_table <- function(supply, demand) {
  ...
  # Calculate PS and CS
  consumer_surplus <- ( intersections$y_int * intersections$x_int ) / 2
  producer_surplus <- (( max(demand$y) - intersections$y_int) * intersections$x_int) / 2
  total_wealfare <-  consumer_surplus + producer_surplus
